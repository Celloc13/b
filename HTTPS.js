...
const userAgentList = [
    ...
    'Mozilla/5.0 (Linux; Android 10; SM-G973U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.136 Mobile Safari/537.36',
...
const sysos = [
    ...
    "Windows 10 Home", "Windows 10 Pro", "Windows 8.1",
    "Windows 7 Ultimate", "Windows XP", "Windows Vista",
    "Ubuntu 20.04 LTS", "Ubuntu 18.04 LTS", "Debian 10",
    "macOS 12.0", "macOS 11.0", "macOS 10.15",
    "Fedora 34", "Fedora 33", "Linux Mint 20.1", 
    "Android 12", "Android 11", "iOS 15", "iOS 14"
];
const winarch = [
    "x86_64", "x86", "ARMv8", "ARMv7", "ARM64", "MIPS", "RISC-V",
    "IA-32", "Itanium", "SPARC", "PowerPC"
];
const winch = [
    "Windows Server 2022", "Windows Server 2019", "Windows Server 2016",
    "Windows Server 2012 R2", "Windows Server 2008 R2", 
    "CentOS 8", "CentOS 7", "Red Hat Enterprise Linux 8",
    "Oracle Linux 7", "Debian 11", "Debian 9", "SUSE Linux Enterprise Server 15"
];
 ...
 const val = { 'NEl': JSON.stringify({
    ...
    {"NEL": JSON.stringify({ report_to: "default", max_age: 31536000, include_subdomains: true })},
    {"dnt": "1"},
    {"A-IM": "Feed"},
    ...
    {"te": "trailers"},
    {"accept-language": language_header[Math.floor(Math.random() * language_header.length)]},
    {"sec-ch-ua": '"Chromium";v="91", "Not A(Brand";v="99", "Edge";v="91"'},
    {"sec-ch-ua-mobile": "?0"},
